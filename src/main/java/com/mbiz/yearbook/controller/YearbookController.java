...
public class YearbookController {
	...
	private final YearbookRepository pageRepo;
...
//
//        List<Yearbook> userPages = pageRepo.findByUser(user);
//
//        //Map<String, List<Yearbook>> groupedPages = userPages.stream()
//                //.collect(Collectors.groupingBy(Yearbook::getCategory));
//
